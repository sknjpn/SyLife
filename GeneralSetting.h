...
public:
  ...
  void load() {
    ...
    m_touchPanelModeEnabled =
        ini.getOr<bool>(U"General", U"TouchPanelModeEnabled", false);
    m_autoTurnOutEnabled =
        ini.getOr<bool>(U"General", U"AutoTurnOutEnabled", false);
    m_autoTurnOutTime = ini.getOr<double>(U"General", U"AutoTurnOutTime", 10);
    m_fullScreenEnabled =
        ini.getOr<bool>(U"General", U"FullScreenEnabled", false);
