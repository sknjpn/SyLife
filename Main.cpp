...
void Main() {
  ...
  if (GeneralSetting::GetInstance().m_audioEnabled) {
    ...
    Resource(U"resources/music/天のきざはし.mp3"), AssetParameter::LoadAsync());
                    AudioAsset::Register(U"沈む。",
    Resource(U"resources/music/沈む。.mp3"), AssetParameter::LoadAsync());
                    AudioAsset::Register(U"かみさまのゆりかご",
    Resource(U"resources/music/かみさまのゆりかご.mp3"),
    AssetParameter::LoadAsync()); AudioAsset::Register(U"真相探求",
    Resource(U"resources/music/真相探求.mp3"), AssetParameter::LoadAsync());
                    AudioAsset::Register(U"安らぎと微睡み",
    Resource(U"resources/music/安らぎと微睡み.mp3"),
    AssetParameter::LoadAsync()); #else AudioAsset::Register(U"天のきざはし",
    U"resources/music/天のきざはし.mp3", AssetParameter::LoadAsync());
                    AudioAsset::Register(U"沈む。",
    U"resources/music/沈む。.mp3", AssetParameter::LoadAsync());
                    AudioAsset::Register(U"かみさまのゆりかご",
    U"resources/music/かみさまのゆりかご.mp3", AssetParameter::LoadAsync());
                    AudioAsset::Register(U"真相探求",
    U"resources/music/真相探求.mp3", AssetParameter::LoadAsync());
                    AudioAsset::Register(U"安らぎと微睡み",
    U"resources/music/安らぎと微睡み.mp3", AssetParameter::LoadAsync());
    #endif*/
  }
